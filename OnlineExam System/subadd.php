...
echo "<br><div style='text-align: center'><h1 class=style8>Subject Adding </h1></div>";
   ...
   <div style="margin:auto;width:90%;height:500px;box-shadow:2px 1px 2px 2px #CCCCCC;">
      <div style="padding-top:5%; text-align:center;">
        <form name="form1" method="post" action="">
           <p class=style7><font size=4>Enter a New Subject Name</font> 
           <input type="text" name="subname" placeholder="enter a subject name" id="subname" required></p>
      </div>
           <p>&nbsp;</p>
