...
<body>
  <?php
     ...
     echo '<div style="margin:auto;width:90%;height:500px;box-shadow:2px 1px 2px 2px #CCCCCC;align:center;font-size:20px"><div style="padding-top:6%"></div>';
     ...
     echo   "<td></td>";
     echo   "<td></td>";
     echo      "<td rowspan=6 width=500px align=center valign=top><img src='images/pr2.jpg' width=200 height=250></td></tr>";
