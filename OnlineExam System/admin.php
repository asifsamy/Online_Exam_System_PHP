...
<body>
  ...
  <?php
    ...
    echo '<h1 class="style8" align= "center">Welcome to Admistrative Area </h1>
  ...
  <table width="100%" border="0">
    <tr>
      <td width="29%" bgcolor="#003366"><div align="center" class="style1">Adminstrative Login</div></td>
        ...
        <form name="form1" method="post" action="">
          ...
          <p class="style2">Password
           ...
           <p><input type="submit" name="submit" id="submit" value="Login"></p>
            <p><a href="index.php"><img src="images/ul.jpg" width="134" height="128"></a></p>
            </form>
      </td>
